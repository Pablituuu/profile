...
export const snapTimeToFrame = (time: number, fps: number) => {
...
export function useTimelinePlayhead({
  ...
  }, [playheadPosition, duration, zoomLevel, rulerScrollRef, isScrubbing]);
...
interface UseTimelinePlayheadRulerProps
  extends Omit<UseTimelinePlayheadProps, 'currentTime'> {}

export function useTimelinePlayheadRuler(props: UseTimelinePlayheadRulerProps) {
