...
export function UpdatesModal() {
  ...
  const updateItems = [
    {
      id: 'sync_logic',
      title: t('updates.sync_logic'),
      description: t('updates.sync_logic_desc'),
    },
    {
      id: 'track_management',
    ...
    {
      id: 'zoom_seeking',
      title: t('updates.zoom_seeking'),
      description: t('updates.zoom_seeking_desc'),
    },
    {
      id: 'clip_tools',
      title: t('updates.clip_tools'),
      description: t('updates.clip_tools_desc'),
    },
  ];
